  ...
  exports.cssCompilers = cssCompilers = {
    styl: {
      ...
      compileSync: function(sourcePath, source) {
        ...
        libs.roots || (libs.roots = (function() {
          try {
            return require('roots-css');
          } catch (e) {
            return function() {
              return function() {};
            };
        ...
        libs.stylus(source, options).use(libs.bootstrap()).use(libs.nib()).use(libs.bootstrap()).use(libs.roots()).use(libs.stylusExtends).set('compress', this.compress).set('include css', true).render(callback);
        return result;
      }
    },
    less: {
